...
public class parameterCooker {
    ...
    public static int preparePopulateCantidadDeDiscos(HttpServletRequest request) {
        int result = 0;
        if (request.getParameter("cantidad") == null) {
            result = 0;
        } else {
            result = Integer.parseInt(request.getParameter("cantidad"));
            if (result < 1) {
                result = 1;
            }
            if (result > 30) {
    ...
    public static int prepareId_genero(HttpServletRequest request) {
        int result = 0;
        if (request.getParameter("id_genero") == null) {
            result = 0;
        } else {
            result = Integer.parseInt(request.getParameter("id_genero"));
        }
        return result;
    }

    public static int prepareId_genero_new(HttpServletRequest request) {
        int result = 0;
        if (request.getParameter("id_genero_new") == null) {
            result = 0;
        } else {
            result = Integer.parseInt(request.getParameter("id_genero_new"));
        }
        return result;
    }
    ...
    public static Integer preparePage(HttpServletRequest request) {
        ...
        if (request.getParameter("pag") == null) {
            ...
            intPage = Integer.parseInt(request.getParameter("pag"));
        }
        return intPage;
    }
